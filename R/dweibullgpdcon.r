#' @name weibullgpdcon
#' 
#' @title Weibull Bulk and GPD Tail Extreme Value Mixture Model with Continuity Constraint
#'
...
#' \code{rweibullgpdcon} any input vector must be of length \code{n}.
#' 
...
#'
#' @seealso \code{\link[evmix:gpd]{gpd}}, \code{\link[stats:Weibull]{dweibull}} and \code{\link[evmix:weibullgpd]{dweibullgpd}}
#' @aliases  weibullgpdcon dweibullgpdcon pweibullgpdcon qweibullgpdcon rweibullgpdcon
#' @family   lweibullgpdcon nlweibullgpdcon fweibullgpdcon
#' 
#' @examples
#' \dontrun{
#' par(mfrow=c(2,2))
